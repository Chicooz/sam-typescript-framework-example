...
const validEvent:APIGatewayAuthorizerEvent = {
    type: 'TOKEN',
    methodArn: 'post',
    authorizationToken: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InNoZXJpZiIsInVzZXJJZCI6IjgzMTQxMzhjLWZmYjMtNGIxOS05NjNiLWI0ZjQ3NDhmODE3ZSIsImlhdCI6MTY3ODQ1MDY1NH0.dXFK_Sc_TV8in_rT-u12eSZN2Yrn0r_rieJvydlMPto'
}
...
const validUser = {
    ...
    authToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InNoZXJpZiIsInVzZXJJZCI6IjgzMTQxMzhjLWZmYjMtNGIxOS05NjNiLWI0ZjQ3NDhmODE3ZSIsImlhdCI6MTY3ODQ1MDY1NH0.dXFK_Sc_TV8in_rT-u12eSZN2Yrn0r_rieJvydlMPto',
}
const invalidUser = {
    userId: 'BADID',
    username: 'sherif',
